...
namespace Media
{
    ...
    public class Mp3MediaStreamSource : MediaStreamSource
    {
        ...
        /// <summary>
        /// A flag to track if we are looping or not
        /// </summary>
        private bool m_fLooping = false;
        ...
        private long audioStreamStartPosition;
        ...
        protected override void OpenMediaAsync()
        {
            ...
            audioStreamStartPosition = result;
            ...
            startFramePosition = result;
            this.currentFrameSize = mpegLayer3Frame.FrameSize;
            startFrameSize = mpegLayer3Frame.FrameSize;
        }
        ...
        protected override void GetSampleAsync(MediaStreamType mediaStreamType)
        {
            ...
            if (this.currentFrameStartPosition + this.currentFrameSize + Id3Version1TagSize >= this.audioStream.Length)
            {
                ...
                {
                    // Reset stream
                    this.audioStream.Position = audioStreamStartPosition;
                    this.currentFrameStartPosition = startFramePosition;
                    this.currentFrameSize = startFrameSize;
                }
                else
                {
