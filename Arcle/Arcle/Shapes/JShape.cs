...
namespace Arbaureal.Arcle.Shapes
{
    public class JShape : BaseShape
    {
        ...
        public JShape(bool fInitialise, int nMoveLeft, int nMoveIn)
        {
            Initialise(fInitialise, nMoveLeft, nMoveIn);
        }

        public JShape(bool fInitialise, int nMoveLeft)
        {
            Initialise(fInitialise, nMoveLeft, 12);
        }

        public JShape(bool fInitialise)
        {
