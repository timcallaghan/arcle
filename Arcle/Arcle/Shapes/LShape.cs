...
namespace Arbaureal.Arcle.Shapes
{
    public class LShape : BaseShape
    {
        ...
        public LShape(bool fInitialise, int nMoveLeft, int nMoveIn)
        {
            Initialise(fInitialise, nMoveLeft, nMoveIn);
        }

        public LShape(bool fInitialise, int nMoveLeft)
        {
            Initialise(fInitialise, nMoveLeft, 12);
        }

        public LShape(bool fInitialise)
        {
